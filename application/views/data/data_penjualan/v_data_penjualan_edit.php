...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
            ...
            <?php echo form_input(array('name'=>'tanggal_transaksi','value'=>$row->tanggal_transaksi,'class'=>'form-control'));?>
        ...
        <div class="form-group">
            ...
            <?php
            echo button('send_form(document.faddmenugrup,"data/data_penjualan/show_editForm/","#divsubcontent")','Simpan','btn btn-success')." ";
            ?>
            </div>
        </div>
    </form>
